...
//! Bevy's flex layout places the node. No vello anywhere in this path — SVG
//! is a CPU raster (`text::svg_raster`) into a child `ImageNode`, and ABC
//! notation renders through MSDF + `MsdfBlockGeometry` (see
//! `view::block_render`).
