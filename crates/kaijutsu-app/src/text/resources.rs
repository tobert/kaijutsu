...
pub struct TextMetrics {
    /// Base font size for content cells (blocks, code). Default: 18.0
    pub cell_font_size: f32,
    /// Line height for content cells. Default: 27.0 (1.5x font size)
...
impl Default for TextMetrics {
    fn default() -> Self {
        Self {
            cell_font_size: 18.0,
            cell_line_height: 27.0, // 1.5x for comfortable reading
            scale_factor: 1.0,
        }
    }
}
