# ABC v2.1 Standard — Local Cache

> **Source:** https://abcnotation.com/wiki/abc:standard:v2.1
> **Fetched:** 2026-05-25
> **Conversion:** HTML → Markdown via `markdownify` (atx headings)
>
> This is a verbatim cache of the wiki page for offline reference while
> bringing `kaijutsu-abc` closer to spec. The upstream page is one long
> wiki document; this copy strips only the navigation chrome (sidebar,
> breadcrumbs, footer) and preserves the spec body, including the wiki's
> own Table of Contents at the top of the document.
>
> Note: v2.1 has **no formal grammar appendix** (no ABNF/BNF). Section 8
> "Abc data format" describes the format in prose; the rest of the spec
> defines syntax informally inside each section.
...
* [1. Introduction](#introduction "abc:standard:v2.1 ↵")

  + [1.1 How to read this document](#how_to_read_this_document "abc:standard:v2.1 ↵")

    - [1.1.1 Terminology / definitions](#terminology_definitions "abc:standard:v2.1 ↵")
  + [1.2 How to avoid reading this document](#how_to_avoid_reading_this_document "abc:standard:v2.1 ↵")
  + [1.3 Abc tutorials](#abc_tutorials "abc:standard:v2.1 ↵")
  + [1.4 Abc extensions](#abc_extensions "abc:standard:v2.1 ↵")
  + [1.5 Further information and changes](#further_information_and_changes "abc:standard:v2.1 ↵")
  + [1.6 Document locations](#document_locations "abc:standard:v2.1 ↵")
* [2. Abc files, tunes and fragments](#abc_files_tunes_and_fragments "abc:standard:v2.1 ↵")

  + [2.1 Abc file identification](#abc_file_identification "abc:standard:v2.1 ↵")
  + [2.2 Abc file structure](#abc_file_structure "abc:standard:v2.1 ↵")

    - [2.2.1 Abc tune](#abc_tune "abc:standard:v2.1 ↵")
    - [2.2.2 File header](#file_header "abc:standard:v2.1 ↵")
    - [2.2.3 Free text and typeset text](#free_text_and_typeset_text "abc:standard:v2.1 ↵")
    - [2.2.4 Empty lines and line-breaking](#empty_lines_and_line-breaking "abc:standard:v2.1 ↵")
    - [2.2.5 Comments and remarks](#comments_and_remarks "abc:standard:v2.1 ↵")
    - [2.2.6 Continuation of input lines](#continuation_of_input_lines "abc:standard:v2.1 ↵")
  + [2.3 Embedded abc and abc fragments](#embedded_abc_and_abc_fragments "abc:standard:v2.1 ↵")

    - [2.3.1 Embedded abc fragment](#embedded_abc_fragment "abc:standard:v2.1 ↵")
    - [2.3.2 Embedded abc tune](#embedded_abc_tune "abc:standard:v2.1 ↵")
    - [2.3.3 Embedded file header](#embedded_file_header "abc:standard:v2.1 ↵")
    - [2.3.4 Embedded abc file](#embedded_abc_file "abc:standard:v2.1 ↵")
* [3. Information fields](#information_fields "abc:standard:v2.1 ↵")

  + [3.1 Description of information fields](#description_of_information_fields "abc:standard:v2.1 ↵")

    - [3.1.1 X: - reference number](#xreference_number "abc:standard:v2.1 ↵")
    - [3.1.2 T: - tune title](#ttune_title "abc:standard:v2.1 ↵")
    - [3.1.3 C: - composer](#ccomposer "abc:standard:v2.1 ↵")
    - [3.1.4 O: - origin](#oorigin "abc:standard:v2.1 ↵")
    - [3.1.5 A: - area](#aarea "abc:standard:v2.1 ↵")
    - [3.1.6 M: - meter](#mmeter "abc:standard:v2.1 ↵")
    - [3.1.7 L: - unit note length](#lunit_note_length "abc:standard:v2.1 ↵")
    - [3.1.8 Q: - tempo](#qtempo "abc:standard:v2.1 ↵")
    - [3.1.9 P: - parts](#pparts "abc:standard:v2.1 ↵")
    - [3.1.10 Z: - transcription](#ztranscription "abc:standard:v2.1 ↵")
    - [3.1.11 N: - notes](#nnotes "abc:standard:v2.1 ↵")
    - [3.1.12 G: - group](#ggroup "abc:standard:v2.1 ↵")
    - [3.1.13 H: - history](#hhistory "abc:standard:v2.1 ↵")
    - [3.1.14 K: - key](#kkey "abc:standard:v2.1 ↵")
    - [3.1.15 R: - rhythm](#rrhythm "abc:standard:v2.1 ↵")
    - [3.1.16 B:, D:, F:, S: - background information](#bdfsbackground_information "abc:standard:v2.1 ↵")
    - [3.1.17 I: - instruction](#iinstruction "abc:standard:v2.1 ↵")
    - [3.1.18 Other fields](#other_fields "abc:standard:v2.1 ↵")
  + [3.2 Use of fields within the tune body](#use_of_fields_within_the_tune_body "abc:standard:v2.1 ↵")
  + [3.3 Field continuation](#field_continuation "abc:standard:v2.1 ↵")
* [4. The tune body](#the_tune_body "abc:standard:v2.1 ↵")

  + [4.1 Pitch](#pitch "abc:standard:v2.1 ↵")
  + [4.2 Accidentals](#accidentals "abc:standard:v2.1 ↵")
  + [4.3 Note lengths](#note_lengths "abc:standard:v2.1 ↵")
  + [4.4 Broken rhythm](#broken_rhythm "abc:standard:v2.1 ↵")
  + [4.5 Rests](#rests "abc:standard:v2.1 ↵")
  + [4.6 Clefs and transposition](#clefs_and_transposition "abc:standard:v2.1 ↵")
  + [4.7 Beams](#beams "abc:standard:v2.1 ↵")
  + [4.8 Repeat/bar symbols](#repeat_bar_symbols "abc:standard:v2.1 ↵")
  + [4.9 First and second repeats](#first_and_second_repeats "abc:standard:v2.1 ↵")
  + [4.10 Variant endings](#variant_endings "abc:standard:v2.1 ↵")
  + [4.11 Ties and slurs](#ties_and_slurs "abc:standard:v2.1 ↵")
  + [4.12 Grace notes](#grace_notes "abc:standard:v2.1 ↵")
  + [4.13 Duplets, triplets, quadruplets, etc.](#duplets_triplets_quadruplets_etc "abc:standard:v2.1 ↵")
  + [4.14 Decorations](#decorations "abc:standard:v2.1 ↵")
  + [4.15 Symbol lines](#symbol_lines "abc:standard:v2.1 ↵")
  + [4.16 Redefinable symbols](#redefinable_symbols "abc:standard:v2.1 ↵")
  + [4.17 Chords and unisons](#chords_and_unisons "abc:standard:v2.1 ↵")
  + [4.18 Chord symbols](#chord_symbols "abc:standard:v2.1 ↵")
  + [4.19 Annotations](#annotations "abc:standard:v2.1 ↵")
  + [4.20 Order of abc constructs](#order_of_abc_constructs "abc:standard:v2.1 ↵")
* [5. Lyrics](#lyrics "abc:standard:v2.1 ↵")

  + [5.1 Alignment](#alignment "abc:standard:v2.1 ↵")
  + [5.2 Verses](#verses "abc:standard:v2.1 ↵")
  + [5.3 Numbering](#numbering "abc:standard:v2.1 ↵")
* [6. Typesetting and playback](#typesetting_and_playback "abc:standard:v2.1 ↵")

  + [6.1 Typesetting](#typesetting "abc:standard:v2.1 ↵")

    - [6.1.1 Typesetting line-breaks](#typesetting_line-breaks "abc:standard:v2.1 ↵")
    - [6.1.2 Typesetting extra space](#typesetting_extra_space "abc:standard:v2.1 ↵")
    - [6.1.3 Typesetting information fields](#typesetting_information_fields "abc:standard:v2.1 ↵")
  + [6.2 Playback](#playback "abc:standard:v2.1 ↵")
* [7. Multiple voices](#multiple_voices "abc:standard:v2.1 ↵")

  + [7.1 Voice properties](#voice_properties "abc:standard:v2.1 ↵")
  + [7.2 Breaking lines](#breaking_lines "abc:standard:v2.1 ↵")
  + [7.3 Inline fields](#inline_fields "abc:standard:v2.1 ↵")
  + [7.4 Voice overlay](#voice_overlay "abc:standard:v2.1 ↵")
* [8. abc data format](#abc_data_format "abc:standard:v2.1 ↵")

  + [8.1 Tune body](#tune_body "abc:standard:v2.1 ↵")
  + [8.2 Text strings](#text_strings "abc:standard:v2.1 ↵")
* [9. Macros](#macros "abc:standard:v2.1 ↵")

  + [9.1 Static macros](#static_macros "abc:standard:v2.1 ↵")
  + [9.2 Transposing macros](#transposing_macros "abc:standard:v2.1 ↵")
* [10. Outdated syntax](#outdated_syntax "abc:standard:v2.1 ↵")

  + [10.1 Outdated information field syntax](#outdated_information_field_syntax "abc:standard:v2.1 ↵")
  + [10.2 Outdated dialects](#outdated_dialects "abc:standard:v2.1 ↵")

    - [10.2.1 Outdated line-breaking](#outdated_line-breaking "abc:standard:v2.1 ↵")
    - [10.2.2 Outdated decorations](#outdated_decorations "abc:standard:v2.1 ↵")
    - [10.2.3 Outdated chords](#outdated_chords "abc:standard:v2.1 ↵")
  + [10.3 Outdated continuations](#outdated_continuations "abc:standard:v2.1 ↵")
  + [10.4 Outdated directives](#outdated_directives "abc:standard:v2.1 ↵")
  + [10.5 Outdated file structure](#outdated_file_structure "abc:standard:v2.1 ↵")

    - [10.5.1 Outdated tune header syntax](#outdated_tune_header_syntax "abc:standard:v2.1 ↵")
    - [10.5.1 Outdated defaults](#outdated_defaults "abc:standard:v2.1 ↵")
  + [10.6 Outdated lyrics alignment](#outdated_lyrics_alignment "abc:standard:v2.1 ↵")
  + [10.7 Other outdated syntax](#other_outdated_syntax "abc:standard:v2.1 ↵")

    - [10.7.1 Disallowed voice overlay](#disallowed_voice_overlay "abc:standard:v2.1 ↵")
* [11. Stylesheet directives and pseudo-comments](#stylesheet_directives_and_pseudo-comments "abc:standard:v2.1 ↵")

  + [11.0 Introduction to directives](#introduction_to_directives "abc:standard:v2.1 ↵")

    - [11.0.1 Disclaimer](#disclaimer "abc:standard:v2.1 ↵")
    - [11.0.2 Stylesheet directives](#stylesheet_directives "abc:standard:v2.1 ↵")
  + [11.1 Voice grouping](#voice_grouping "abc:standard:v2.1 ↵")
  + [11.2 Instrumentation directives](#instrumentation_directives "abc:standard:v2.1 ↵")
  + [11.3 Accidental directives](#accidental_directives "abc:standard:v2.1 ↵")
  + [11.4 Formatting directives](#formatting_directives "abc:standard:v2.1 ↵")

    - [11.4.1 Page format directives](#page_format_directives "abc:standard:v2.1 ↵")
    - [11.4.2 Font directives](#font_directives "abc:standard:v2.1 ↵")
    - [11.4.3 Space directives](#space_directives "abc:standard:v2.1 ↵")
    - [11.4.4 Measure directives](#measure_directives "abc:standard:v2.1 ↵")
    - [11.4.5 Text directives](#text_directives "abc:standard:v2.1 ↵")
    - [11.4.6 Information directives](#information_directives "abc:standard:v2.1 ↵")
    - [11.4.7 Separation directives](#separation_directives "abc:standard:v2.1 ↵")
    - [11.4.8 Miscellaneous directives](#miscellaneous_directives "abc:standard:v2.1 ↵")
  + [11.5 Application specific directives](#application_specific_directives "abc:standard:v2.1 ↵")
  + [11.6 Further information about directives](#further_information_about_directives "abc:standard:v2.1 ↵")
* [12. Dialects, strict / loose interpretation and backwards compatibility](#dialects_strict_loose_interpretation_and_backwards_compatibility "abc:standard:v2.1 ↵")

  + [12.1 Dialect differences](#dialect_differences "abc:standard:v2.1 ↵")

    - [12.1.1 Line-breaking dialects](#line-breaking_dialects "abc:standard:v2.1 ↵")
    - [12.1.2 Decoration dialects](#decoration_dialects "abc:standard:v2.1 ↵")
    - [12.1.3 Chord dialects](#chord_dialects "abc:standard:v2.1 ↵")
  + [12.2 Loose interpretation](#loose_interpretation "abc:standard:v2.1 ↵")
  + [12.3 Strict interpretation](#strict_interpretation "abc:standard:v2.1 ↵")
* [13. Sample abc tunes](#sample_abc_tunes "abc:standard:v2.1 ↵")

  + [13.1 English.abc](#englishabc "abc:standard:v2.1 ↵")
  + [13.2 Strspys.abc](#strspysabc "abc:standard:v2.1 ↵")
  + [13.3 Reels.abc](#reelsabc "abc:standard:v2.1 ↵")
  + [13.4 Canzonetta.abc](#canzonettaabc "abc:standard:v2.1 ↵")
* [14. Appendix](#appendix "abc:standard:v2.1 ↵")

  + [14.1 Supported accents & ligatures](#supported_accents_ligatures "abc:standard:v2.1 ↵")
  + [14.2 Errata](#errata "abc:standard:v2.1 ↵")
...
* [abc file](#abc_file_definition "abc:standard:v2.1 ↵")
* [abc fragment](#abc_fragment_definition "abc:standard:v2.1 ↵")
* [abc tune](#abc_tune_definition "abc:standard:v2.1 ↵")
* [abc tunebook](#abc_tunebook_definition "abc:standard:v2.1 ↵")
* [code line-break](#code_line-break_definition "abc:standard:v2.1 ↵")
* [comment](#comment_definition "abc:standard:v2.1 ↵")
* [embedded](#embedded_definition "abc:standard:v2.1 ↵")
* [empty line](#empty_line_definition "abc:standard:v2.1 ↵")
* [file header](#file_header_definition "abc:standard:v2.1 ↵")
* [free text](#free_text_definition "abc:standard:v2.1 ↵")
* [information field](#information_field_definition "abc:standard:v2.1 ↵")
* [inline field](#inline_field_definition "abc:standard:v2.1 ↵")
* [music code](#music_code_definition "abc:standard:v2.1 ↵")
* [score line-break](#score_line-break_definition "abc:standard:v2.1 ↵")
* [stylesheet directive](#stylesheet_directive_definition "abc:standard:v2.1 ↵")
* [text string](#text_string_definition "abc:standard:v2.1 ↵")
* [tune body](#tune_body_definition "abc:standard:v2.1 ↵")
* [tune header](#tune_header_definition "abc:standard:v2.1 ↵")
* [typeset text](#typeset_text_definition "abc:standard:v2.1 ↵")
...
* [5. Lyrics](#lyrics "abc:standard:v2.1 ↵") for transcribing songs
* [6.1 Typesetting](#typesetting "abc:standard:v2.1 ↵") for printing abc transcriptions in staff notation
* [7. Multiple voices](#multiple_voices "abc:standard:v2.1 ↵") for working with multi-voice music
...
* [http://www.lesession.co.uk/abc/abc\_notation.htm](http://www.lesession.co.uk/abc/abc_notation.htm "http://www.lesession.co.uk/abc/abc_notation.htm")
...
* [abcnotation.com/wiki/abc:standard:route-map](/wiki/abc:standard:route-map "abc:standard:route-map") - a route map of proposed changes to the standard plus instructions for proposing changes

### 1.6 Document locations

This document can be found at:

* [abcnotation.com/wiki/abc:standard:v2.1](/wiki/abc:standard:v2.1 "abc:standard:v2.1")

The latest version of the standard, plus links to older versions and other developmental work, can always be found via:

* [abcnotation.com/wiki/abc:standard](/wiki/abc:standard "abc:standard")
...
*Note for developers:*  Software should ignore the [byte order mark](http://en.wikipedia.org/wiki/Byte_order_mark "http://en.wikipedia.org/wiki/Byte_order_mark") (BOM) if encountered as the first character of the file.
...
<html><a name="abc\_file\_definition"></a></html>An **abc file** consists of one or more [abc tune](#abc_tune_definition "abc:standard:v2.1 ↵") transcriptions, optionally interspersed with [free text](#free_text_definition "abc:standard:v2.1 ↵") and [typeset text](#typeset_text_definition "abc:standard:v2.1 ↵") annotations. It may optionally start with a [file header](#file_header_definition "abc:standard:v2.1 ↵") to set up default values for processing the file.

The [file header](#file_header_definition "abc:standard:v2.1 ↵"), [abc tunes](#abc_tune_definition "abc:standard:v2.1 ↵") and [text annotations](#free_text_and_typeset_text "abc:standard:v2.1 ↵") are separated from each other by [empty lines](#empty_line_definition "abc:standard:v2.1 ↵") (also known as blank lines).

<html><a name="abc\_tunebook\_definition"></a></html>An [abc file](#abc_file_definition "abc:standard:v2.1 ↵") with more than one tune in it is called an **abc tunebook**.

#### 2.2.1 Abc tune

<html><a name="abc\_tune\_definition"></a></html>An **abc tune** itself consists of a [tune header](#tune_header_definition "abc:standard:v2.1 ↵") and a [tune body](#tune_body_definition "abc:standard:v2.1 ↵"), terminated by an [empty line](#empty_line_definition "abc:standard:v2.1 ↵") or the end of the [file](#abc_file_definition "abc:standard:v2.1 ↵"). It may also contain [comment lines](#comment_definition "abc:standard:v2.1 ↵") or [stylesheet directives](#stylesheet_directive_definition "abc:standard:v2.1 ↵").

<html><a name="tune\_header\_definition"></a></html>The **tune header** is composed of several [information field](#information_field_definition "abc:standard:v2.1 ↵") lines, which are further discussed in [information fields](#information_fields "abc:standard:v2.1 ↵"). The [tune header](#tune_header_definition "abc:standard:v2.1 ↵") should start with an `X:`(reference number) field followed by a `T:`(title) field and finish with a `K:`(key) field.

<html><a name="tune\_body\_definition"></a></html>The **tune body**, which contains the [music code](#music_code_definition "abc:standard:v2.1 ↵"), follows immediately after. Certain fields may also be used inside the tune body - see [use of fields within the tune body](#use_of_fields_within_the_tune_body "abc:standard:v2.1 ↵").

It is legal to write an [abc tune](#abc_tune_definition "abc:standard:v2.1 ↵") without a [tune body](#tune_body_definition "abc:standard:v2.1 ↵"). This feature can be used to document tunes without transcribing them.

<html><a name="music\_code\_definition"></a></html>Abc **music code** lines are those lines in the [tune body](#tune_body_definition "abc:standard:v2.1 ↵") which give notes, bar lines and other musical symbols - see [the tune body](#the_tune_body "abc:standard:v2.1 ↵") for details. In effect, music code is the contents of any line which is not an [information field](#information_field_definition "abc:standard:v2.1 ↵"), [stylesheet directive](#stylesheet_directive_definition "abc:standard:v2.1 ↵") or [comment line](#comment_definition "abc:standard:v2.1 ↵").

#### 2.2.2 File header

<html><a name="file\_header\_definition"></a></html>The file may optionally start with a **file header** (immediately after the version field), consisting of a block of consecutive [information fields](#information_field_definition "abc:standard:v2.1 ↵"), [stylesheet directives](#stylesheet_directive_definition "abc:standard:v2.1 ↵"), or both, terminated with an [empty line](#empty_line_definition "abc:standard:v2.1 ↵"). The [file header](#file_header_definition "abc:standard:v2.1 ↵") is used to set default values for the tunes in the file.
...
<html><a name="free\_text\_definition"></a></html>**Free text** is just that. It can be included anywhere in an [abc file](#abc_file_definition "abc:standard:v2.1 ↵"), after the [file header](#file_header_definition "abc:standard:v2.1 ↵"), but must be separated from [abc tunes](#abc_tune_definition "abc:standard:v2.1 ↵"), [typeset text](#typeset_text_definition "abc:standard:v2.1 ↵") and the [file header](#file_header_definition "abc:standard:v2.1 ↵") by [empty lines](#empty_line_definition "abc:standard:v2.1 ↵"). Typically it is used for annotating the [abc file](#abc_file_definition "abc:standard:v2.1 ↵") but in principle can be any text not containing [information fields](#information_field_definition "abc:standard:v2.1 ↵").

*Comment:*  Since raw html markup and email headers are treated as [free text](#free_text_definition "abc:standard:v2.1 ↵") (provided they don't inadvertently contain [information fields](#information_field_definition "abc:standard:v2.1 ↵")) this means that abc software can process a wide variety of text-based input files just by ignoring non-abc code.
...
<html><a name="empty\_line\_definition"></a></html>**Empty lines** (also known as blank lines) are used to separate [abc tunes](#abc_tune_definition "abc:standard:v2.1 ↵"), [free text](#free_text_definition "abc:standard:v2.1 ↵") and the [file header](#file_header_definition "abc:standard:v2.1 ↵"). They also aid the readability of [abc files](#abc_file_definition "abc:standard:v2.1 ↵").
...
<html><a name="comment\_definition"></a></html>A percent symbol (`%`) will cause the remainder of any input line to be ignored. It can be used to add a **comment** to the end of an abc line or as a **comment line** in its own right. (To get a percent symbol, type `\%` - see [text strings](#text_strings "abc:standard:v2.1 ↵").)

<html><a name="remark\_definition"></a></html>Alternatively, you can use the syntax `[r:remark]` to write a **remark** in the middle of a line of music.
...
*Comment for programmers:*  The backslash effectively acts as a continuation character for [music code](#music_code_definition "abc:standard:v2.1 ↵") lines, although, for those used to encountering it in other computer language contexts, its use is very abc-specific. In particular it can continue [music code](#music_code_definition "abc:standard:v2.1 ↵") lines through [information fields](#information_field_definition "abc:standard:v2.1 ↵"), [comments](#comment_definition "abc:standard:v2.1 ↵") and [stylesheet directives](#stylesheet_directive_definition "abc:standard:v2.1 ↵").

The 3 other input line types can be continued as follows:

* [information fields](#information_field_definition "abc:standard:v2.1 ↵") can be continued using `+:` at the start of the following line - see [field continuation](#field_continuation "abc:standard:v2.1 ↵");
...
* most [stylesheet directives](#stylesheet_directive_definition "abc:standard:v2.1 ↵") are too short to require a continuation syntax, but if one is required then use the `I:<directive>` form (see `I:instruction`), in place of `%%<directive>` and continue the line as a field - see [field continuation](#field_continuation "abc:standard:v2.1 ↵").
...
* an [abc fragment](#abc_fragment_definition "abc:standard:v2.1 ↵")
* an [abc tune](#abc_tune_definition "abc:standard:v2.1 ↵")
* a [file header](#file_header_definition "abc:standard:v2.1 ↵")
* an entire [abc file](#abc_file_definition "abc:standard:v2.1 ↵")
...
The following rules are applied to [embedded](#embedded_definition "abc:standard:v2.1 ↵") elements:

#### 2.3.1 Embedded abc fragment

An <html><a name="abc\_fragment\_definition"></a></html>**abc fragment** is a partial [abc tune](#abc_tune_definition "abc:standard:v2.1 ↵"). It may contain a partial [tune header](#tune_header_definition "abc:standard:v2.1 ↵") with no body or a [tune body](#tune_body_definition "abc:standard:v2.1 ↵") with optional [tune header](#tune_header_definition "abc:standard:v2.1 ↵") [information fields](#information_field_definition "abc:standard:v2.1 ↵").

*Example 1:*  A fragment with no [tune header](#tune_header_definition "abc:standard:v2.1 ↵"):
...
*Example 2:*  A fragment with a partial [tune header](#tune_header_definition "abc:standard:v2.1 ↵"):
...
*Note for developers:*  For processing as an [abc tune](#abc_tune_definition "abc:standard:v2.1 ↵"), the parsing code is notionally assumed to add empty `X:`, `T:` and `K:` fields, if these are missing. However, since the processing generally takes place internally within a software package, these need not be added in actuality.

#### 2.3.2 Embedded abc tune

An [embedded](#embedded_definition "abc:standard:v2.1 ↵") [abc tune](#abc_tune_definition "abc:standard:v2.1 ↵") has the same structure as an ordinary [abc tune](#abc_tune_definition "abc:standard:v2.1 ↵") except that it does not require an [empty line](#empty_line_definition "abc:standard:v2.1 ↵") to mark the end of the [tune body](#tune_body_definition "abc:standard:v2.1 ↵").

An [embedded](#embedded_definition "abc:standard:v2.1 ↵") [abc tune](#abc_tune_definition "abc:standard:v2.1 ↵") could also be identified as an [abc fragment](#abc_fragment_definition "abc:standard:v2.1 ↵") (albeit complete), if preferred.

#### 2.3.3 Embedded file header

As with the [file header](#file_header_definition "abc:standard:v2.1 ↵"), an [embedded](#embedded_definition "abc:standard:v2.1 ↵") [file header](#file_header_definition "abc:standard:v2.1 ↵") can be used to set default values for all [embedded](#embedded_definition "abc:standard:v2.1 ↵") abc tunes and [abc fragments](#abc_fragment_definition "abc:standard:v2.1 ↵") within the document.

*Example:*  For setting the title font in every [abc tune](#abc_tune_definition "abc:standard:v2.1 ↵") in the document:
...
Like its counterpart, there must only be one [embedded](#embedded_definition "abc:standard:v2.1 ↵") [file header](#file_header_definition "abc:standard:v2.1 ↵") per document and it should precede all other [embedded](#embedded_definition "abc:standard:v2.1 ↵") abc tunes and [abc fragments](#abc_fragment_definition "abc:standard:v2.1 ↵").

#### 2.3.4 Embedded abc file

A document may include an entire [embedded](#embedded_definition "abc:standard:v2.1 ↵") [abc file](#abc_file_definition "abc:standard:v2.1 ↵") with the usual structure - see [abc file structure](#abc_file_structure "abc:standard:v2.1 ↵").

An [embedded](#embedded_definition "abc:standard:v2.1 ↵") [abc file](#abc_file_definition "abc:standard:v2.1 ↵") should be treated independently from other [embedded](#embedded_definition "abc:standard:v2.1 ↵") elements so that settings in one [embedded](#embedded_definition "abc:standard:v2.1 ↵") [abc file](#abc_file_definition "abc:standard:v2.1 ↵") do not affect other [embedded](#embedded_definition "abc:standard:v2.1 ↵") elements.

*Recommendation:*  As a consequence, using other [embedded](#embedded_definition "abc:standard:v2.1 ↵") elements in a document that contains an [embedded](#embedded_definition "abc:standard:v2.1 ↵") [abc file](#abc_file_definition "abc:standard:v2.1 ↵") is not recommended.
...
<html><a name="information\_field\_definition"></a></html>Any line beginning with a letter in the range `A-Z` or `a-z` and immediately followed by a colon (`:`) is an **information field**. Information fields are used to notate things such as composer, meter, etc. In fact anything that isn't music.
...
Some [information fields](#information_field_definition "abc:standard:v2.1 ↵") are permitted only in the file or [tune header](#tune_header_definition "abc:standard:v2.1 ↵") and some only in the [tune body](#tune_body_definition "abc:standard:v2.1 ↵"), while others are allowed in both locations. [information field](#information_field_definition "abc:standard:v2.1 ↵") identifiers `A-G`, `X-Z` and `a-g`, `x-z` are not permitted in the body to avoid confusion with [note symbols](#pitch "abc:standard:v2.1 ↵"), [rests](#rests "abc:standard:v2.1 ↵") and [spacers](#typesetting_extra_space "abc:standard:v2.1 ↵").
...
*Recommendation for newcomers:*  A good way to find out how to use the fields is to look at the example files, [sample abc tunes](#sample_abc_tunes "abc:standard:v2.1 ↵") (in particular [English.abc](#englishabc "abc:standard:v2.1 ↵")), and try out some examples.
...
| Field name | [file header](#file_header_definition "abc:standard:v2.1 ↵") | [tune header](#tune_header_definition "abc:standard:v2.1 ↵") | [tune body](#tune_body_definition "abc:standard:v2.1 ↵") | [inline](#inline_field_definition "abc:standard:v2.1 ↵") | type | Examples and notes |
| --- | --- | --- | --- | --- | --- | --- |
| [A:area](#aarea "abc:standard:v2.1 ↵") | yes | yes |  |  | string | A:Donegal, A:Bampton ([deprecated](#outdated_information_field_syntax "abc:standard:v2.1 ↵")) |
| [B:book](#bdfsbackground_information "abc:standard:v2.1 ↵") | yes | yes |  |  | string | B:O'Neills |
| [C:composer](#ccomposer "abc:standard:v2.1 ↵") | yes | yes |  |  | string | C:Robert Jones, C:Trad. |
| [D:discography](#bdfsbackground_information "abc:standard:v2.1 ↵") | yes | yes |  |  | string | D:Chieftains IV |
| [F:file url](#bdfsbackground_information "abc:standard:v2.1 ↵") | yes | yes |  |  | string | F:http://a.b.c/file.abc |
| [G:group](#ggroup "abc:standard:v2.1 ↵") | yes | yes |  |  | string | G:flute |
| [H:history](#hhistory "abc:standard:v2.1 ↵") | yes | yes |  |  | string | H:The story behind this tune … |
| [I:instruction](#iinstruction "abc:standard:v2.1 ↵") | yes | yes | yes | yes | instruction | I:papersize A4, I:newpage |
| [K:key](#kkey "abc:standard:v2.1 ↵") |  | last | yes | yes | instruction | K:G, K:Dm, K:AMix |
| [L:unit note length](#lunit_note_length "abc:standard:v2.1 ↵") | yes | yes | yes | yes | instruction | L:1/4, L:1/8 |
| [M:meter](#mmeter "abc:standard:v2.1 ↵") | yes | yes | yes | yes | instruction | M:3/4, M:4/4 |
| [m:macro](#macros "abc:standard:v2.1 ↵") | yes | yes | yes | yes | instruction | m: ~G2 = {A}G{F}G |
| [N:notes](#nnotes "abc:standard:v2.1 ↵") | yes | yes | yes | yes | string | N:see also O'Neills - 234 |
| [O:origin](#oorigin "abc:standard:v2.1 ↵") | yes | yes |  |  | string | O:UK; Yorkshire; Bradford |
| [P:parts](#pparts "abc:standard:v2.1 ↵") |  | yes | yes | yes | instruction | P:A, P:ABAC, P:(A2B)3 |
| [Q:tempo](#qtempo "abc:standard:v2.1 ↵") |  | yes | yes | yes | instruction | Q:"allegro" 1/4=120 |
| [R:rhythm](#rrhythm "abc:standard:v2.1 ↵") | yes | yes | yes | yes | string | R:R, R:reel |
| [r:remark](#comments_and_remarks "abc:standard:v2.1 ↵") | yes | yes | yes | yes | - | r:I love abc |
| [S:source](#bdfsbackground_information "abc:standard:v2.1 ↵") | yes | yes |  |  | string | S:collected in Brittany |
| [s:symbol line](#symbol_lines "abc:standard:v2.1 ↵") |  |  | yes |  | instruction | s: !pp! \*\* !f! |
| [T:tune title](#ttune_title "abc:standard:v2.1 ↵") |  | second | yes |  | string | T:Paddy O'Rafferty |
| [U:user defined](#redefinable_symbols "abc:standard:v2.1 ↵") | yes | yes | yes | yes | instruction | U: T = !trill! |
| [V:voice](#multiple_voices "abc:standard:v2.1 ↵") |  | yes | yes | yes | instruction | V:4 clef=bass |
| [W:words](#lyrics "abc:standard:v2.1 ↵") |  | yes | yes |  | string | W:lyrics printed after the end of the tune |
| [w:words](#lyrics "abc:standard:v2.1 ↵") |  |  | yes |  | string | w:lyrics printed aligned with the notes of a tune |
| [X:reference number](#xreference_number "abc:standard:v2.1 ↵") |  | first |  |  | instruction | X:1, X:2 |
| [Z:transcription](#ztranscription "abc:standard:v2.1 ↵") | yes | yes |  |  | string | Z:John Smith, <j.s@mail.com> |
...
*Comment:*  Since [stylesheet directives](#stylesheet_directive_definition "abc:standard:v2.1 ↵") are optional, and not necessarily portable from one program to another, this means that `I:` fields containing [stylesheet directives](#stylesheet_directive_definition "abc:standard:v2.1 ↵") should be treated liberally by abc software and, in particular, that `I:` fields which are not recognised should be ignored.
...
| directive | section |
| --- | --- |
| `I:abc-charset` | [charset field](#charset_field "abc:standard:v2.1 ↵") |
| `I:abc-version` | [version field](#version_field "abc:standard:v2.1 ↵") |
| `I:abc-include` | [include field](#include_field "abc:standard:v2.1 ↵") |
| `I:abc-creator` | [creator field](#creator_field "abc:standard:v2.1 ↵") |
...
The `I:abc-include <filename.abh>` imports the definitions found in a separate abc header file (.abh), and inserts them into the [file header](#file_header_definition "abc:standard:v2.1 ↵") or [tune header](#tune_header_definition "abc:standard:v2.1 ↵").
...
* For `m:` see [macros](#macros "abc:standard:v2.1 ↵").
* For `r:` see [comments and remarks](#comments_and_remarks "abc:standard:v2.1 ↵").
* For `s:` see [symbol lines](#symbol_lines "abc:standard:v2.1 ↵").
* For `U:` see [redefinable symbols](#redefinable_symbols "abc:standard:v2.1 ↵").
* For `V:` see [multiple voices](#multiple_voices "abc:standard:v2.1 ↵").
* For `W:` and `w:` see [lyrics](#lyrics "abc:standard:v2.1 ↵").

### 3.2 Use of fields within the tune body

<html><a name="inline\_field\_definition"></a></html>It is often desired to change the key (`K`), meter (`M`), or unit note length (`L`) mid-tune. These, and most other [information fields](#information_field_definition "abc:standard:v2.1 ↵") which can be legally used within the [tune body](#tune_body_definition "abc:standard:v2.1 ↵"), can be specified as an **inline field** by placing them within square brackets in a line of music
...
See [information fields](#information_fields "abc:standard:v2.1 ↵") for a table showing the fields that may appear within the body and those that may be used inline.
...
*Recommendation for GUI developers:*  Sometimes users may wish to paste paragraphs of text into an [abc file](#abc_file_definition "abc:standard:v2.1 ↵"), particularly in the `H:(history)` field. GUI developers are recommended to provide tools for reformatting such paragraphs, for example by splitting them into several lines each prefixed by `+:`.
...
[![](/wiki/_media/abc:standard:pitches.0000.png)](/wiki/_detail/abc:standard:pitches.0000.png?id=abc%3Astandard%3Av2.1 "abc:standard:pitches.0000.png")
...
[![](/wiki/_media/abc:standard:broken-80.png)](/wiki/_detail/abc:standard:broken-80.png?id=abc%3Astandard%3Av2.1 "abc:standard:broken-80.png")
...
[![](/wiki/_media/abc:standard:rests1-80.png)](/wiki/_detail/abc:standard:rests1-80.png?id=abc%3Astandard%3Av2.1 "abc:standard:rests1-80.png")

```
z4|z4|z4|z4|CD EF|GA Bc
```

[![](/wiki/_media/abc:standard:rests2-80.png)](/wiki/_detail/abc:standard:rests2-80.png?id=abc%3Astandard%3Av2.1 "abc:standard:rests2-80.png")
...
[![](/wiki/_media/abc:standard:slur2-80.png)](/wiki/_detail/abc:standard:slur2-80.png?id=abc%3Astandard%3Av2.1 "abc:standard:slur2-80.png")
...
[![](/wiki/_media/abc:standard:graces-80.png)](/wiki/_detail/abc:standard:graces-80.png?id=abc%3Astandard%3Av2.1 "abc:standard:graces-80.png")
...
[![](/wiki/_media/abc:standard:decorations2-80.png)](/wiki/_detail/abc:standard:decorations2-80.png?id=abc%3Astandard%3Av2.1 "abc:standard:decorations2-80.png")
...
*Recommendation:*  A good source of general information about decorations can be found at [http://www.dolmetsch.com/musicalsymbols.htm](http://www.dolmetsch.com/musicalsymbols.htm "http://www.dolmetsch.com/musicalsymbols.htm").
...
[![](/wiki/_media/abc:standard:unison-80.png)](/wiki/_detail/abc:standard:unison-80.png?id=abc%3Astandard%3Av2.1 "abc:standard:unison-80.png")
...
*Note to developers:*  Software should also be able to recognise and handle appropriately the unicode versions of flat, natural and sharp symbols (♭, ♮, ♯) - see [special symbols](#special_symbols "abc:standard:v2.1 ↵").
...
The `W:` [information field](#information_field_definition "abc:standard:v2.1 ↵") (uppercase W) can be used for lyrics to be printed separately below the tune.
...
* <html><a name="code\_line-break\_definition"></a></html>a **code line-break**, meaning a line-break in the abc [tune body](#tune_body_definition "abc:standard:v2.1 ↵"), and, in particular, at the end of a line of [music code](#music_code_definition "abc:standard:v2.1 ↵");
* <html><a name="score\_line-break\_definition"></a></html>a **score line-break**, meaning a line-break in the printed score.
...
* "`I:linebreak $`" indicates that the `$` symbol is used in the [tune body](#tune_body_definition "abc:standard:v2.1 ↵") to typeset a [score line-break](#score_line-break_definition "abc:standard:v2.1 ↵"). Any [code line-breaks](#code_line-break_definition "abc:standard:v2.1 ↵") are ignored for typesetting purposes.
...
*Comment:*  The "`I:linebreak !`" instruction works in the same way as `I:linebreak $` and is primarily provided for backwards compatibility - see [line-breaking dialects](#line-breaking_dialects "abc:standard:v2.1 ↵"), so that "`I:linebreak $`" is the preferred usage. "`I:linebreak !`" also automatically invokes the "`I:decoration +`" instruction - see [decoration dialects](#decoration_dialects "abc:standard:v2.1 ↵"). Finally, "`I:linebreak !`" is equivalent to the [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") directive `%%continueall true` - see [outdated directives](#outdated_directives "abc:standard:v2.1 ↵").

* "`I:linebreak <EOL>`" indicates that the End Of Line character (CR, LF or CRLF) is used to typeset a [score line-break](#score_line-break_definition "abc:standard:v2.1 ↵"). In other words, [code line-breaks](#code_line-break_definition "abc:standard:v2.1 ↵") are used for typesetting [score line-breaks](#score_line-break_definition "abc:standard:v2.1 ↵").
...
meaning that both [code line-breaks](#code_line-break_definition "abc:standard:v2.1 ↵"), and `$` symbols, generate a [score line-break](#score_line-break_definition "abc:standard:v2.1 ↵").

*Comment:*  Although "`I:linebreak $ !`" is legal it is not recommended as it uses two different symbols to mean the same thing.

An `I:linebreak` instruction can be used either in the [file header](#file_header_definition "abc:standard:v2.1 ↵") (in which case it is applied to every [tune](#abc_tune_definition "abc:standard:v2.1 ↵") in the [abc file](#abc_file_definition "abc:standard:v2.1 ↵")), or in a [tune header](#tune_header_definition "abc:standard:v2.1 ↵") (in which case it is applied to that tune only and overrides a line-breaking instruction in the [file header](#file_header_definition "abc:standard:v2.1 ↵")). Similarly, if two `I:linebreak` instructions appear in a [file header](#file_header_definition "abc:standard:v2.1 ↵") or a [tune header](#tune_header_definition "abc:standard:v2.1 ↵"), the second cancels the first.
...
When the `<EOL>` character is being used in the [tune body](#tune_body_definition "abc:standard:v2.1 ↵") to indicate [score line-breaks](#score_line-break_definition "abc:standard:v2.1 ↵"), it sometimes useful to be able to tell typesetting software to ignore a particular [code line-breaks](#code_line-break_definition "abc:standard:v2.1 ↵"). This is achieved using a backslash (`\`) at the end of a line of [music code](#music_code_definition "abc:standard:v2.1 ↵"). The backslash may be followed by trailing whitespace and/or [comments](#comment_definition "abc:standard:v2.1 ↵"), since they are removed before the line is processed.
...
In the examples above, where a line of [music code](#music_code_definition "abc:standard:v2.1 ↵") follows immediately after a line ending in backslash, the backslash acts as a continuation for two lines of [music code](#music_code_definition "abc:standard:v2.1 ↵") and can therefore be used to split up long [music code](#music_code_definition "abc:standard:v2.1 ↵") lines.

More importantly, however, any [information fields](#information_field_definition "abc:standard:v2.1 ↵") and [stylesheet directives](#stylesheet_directive_definition "abc:standard:v2.1 ↵") are processed (and [comments](#comment_definition "abc:standard:v2.1 ↵") are removed) at the point where the physical line-break occurs. Hence the backslash is commonly used to include meter or key changes halfway through a line of music.
...
*Alternative usage example:*  The above could also be achieved using [inline fields](#inline_field_definition "abc:standard:v2.1 ↵"), the `I:<directive>` form instead of `%%<directive>` and a `r:remark` in place of the [comment](#comment_definition "abc:standard:v2.1 ↵"), i.e.

```
abc cab|[I:setbarnb 10][M:9/8][r:comment]abc cba abc|
```

Finally, note that if the the `<EOL>` character is not being used to indicate [score line-breaks](#score_line-break_definition "abc:standard:v2.1 ↵"), then the backslash is effectively redundant.

*Recommendation to users:*  If you find that you are using backslash symbols on most lines of [music code](#music_code_definition "abc:standard:v2.1 ↵"), then consider instead using "`I:linebreak <none>`" or "`I:linebreak $`" which will mean that all the [code line-breaks](#code_line-break_definition "abc:standard:v2.1 ↵") will be ignored for the purposes of generating [score line-breaks](#score_line-break_definition "abc:standard:v2.1 ↵") (and, in the latter case, you can encode a [score line-breaks](#score_line-break_definition "abc:standard:v2.1 ↵") with the `$` character).
...
Note that the `y` symbol does *not* create [rests](#rests "abc:standard:v2.1 ↵") in the music.
...
* each `P:part` in the [tune body](#tune_body_definition "abc:standard:v2.1 ↵") should have the string identifying it printed immediately above the start of that part; if there is a `P:parts` field in the [tune header](#tune_header_definition "abc:standard:v2.1 ↵") (describing which order the parts are played in) it should be printed left-aligned above the start of the tune
* the `Q:tempo` should be printed above the tune at the start of the section to which it applies
* the aligned `w:words` (lyrics) should be printed under each line of music with other `W:words` printed beneath the tune - see [lyrics](#lyrics "abc:standard:v2.1 ↵")

To suppress any of these, or alternatively to typeset additional [information fields](#information_field_definition "abc:standard:v2.1 ↵") such as notes (N), history (H), rhythm (R), book (B), discography (D), file (F), source (S) or transcription (Z), use the `%%writefields` directive - see [information directives](#information_directives "abc:standard:v2.1 ↵").

To customise the typesetting (for example, by changing the font), see [formatting directives](#formatting_directives "abc:standard:v2.1 ↵").

### 6.2 Playback

Many of the [information fields](#information_field_definition "abc:standard:v2.1 ↵") are ignored by playback programs - exceptions are `I:`, `K:`, `L:`, `M:`, `m:`, `P;`, `Q:`, `s:`, `U:` and `V:`.
...
Most playback customisation is handled by [instrumentation directives](#instrumentation_directives "abc:standard:v2.1 ↵").
...
The `V:` field allows the writing of multi-voice music. In multi-voice [abc tunes](#abc_tune_definition "abc:standard:v2.1 ↵"), the [tune body](#tune_body_definition "abc:standard:v2.1 ↵") is divided into several voices, each beginning with a `V:` field. All the notes following such a `V:` field, up to the next `V:` field or the end of the [tune body](#tune_body_definition "abc:standard:v2.1 ↵"), belong to the voice.
...
where ID can be either a number or a string, that uniquely identifies the voice in question. When using a string, only the first 20 characters of it will be distinguished. The ID will not be printed on the staff; it's only function is to indicate, throughout the [abc tune](#abc_tune_definition "abc:standard:v2.1 ↵"), which music line belongs to which voice.
...
* **clef=** - specifies a clef; see [clefs and transposition](#clefs_and_transposition "abc:standard:v2.1 ↵") for details.

The name specifier may be abbreviated to `nm=`. The subname specifier may be abbreviated to `snm=`.

Applications may implement their own specifiers, but must gracefully ignore specifiers they don't understand or implement. This is required for portability of [abc files](#abc_file_definition "abc:standard:v2.1 ↵") between applications.

### 7.2 Breaking lines

*VOLATILE:*  See [above](#multiple_voices "abc:standard:v2.1 ↵"). In particular the following may be relaxed with the introduction of a control voice.

The rules for [typesetting line-breaks](#typesetting_line-breaks "abc:standard:v2.1 ↵") in multi-voice [abc tunes](#abc_tune_definition "abc:standard:v2.1 ↵") are the same as for single voice music although additionally a line-break in one voice must be matched in the other voices. See the example tune [Canzonetta.abc](#canzonettaabc "abc:standard:v2.1 ↵").
...
[![](/wiki/_media/abc:standard:overlay3-80.png)](/wiki/_detail/abc:standard:overlay3-80.png?id=abc%3Astandard%3Av2.1 "abc:standard:overlay3-80.png")

This revokes the abc 2.0 usage of `&` in `w:` and `s:` lines, which is now [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") (see [disallowed](#disallowed_voice_overlay "abc:standard:v2.1 ↵")).
...
<html><a name="text\_string\_definition"></a></html>Text written within an [abc file](#abc_file_definition "abc:standard:v2.1 ↵"), either as part of an [information field](#information_field_definition "abc:standard:v2.1 ↵"), an [annotation](#annotations "abc:standard:v2.1 ↵") or as [free text](#free_text_definition "abc:standard:v2.1 ↵") / [typeset text](#typeset_text_definition "abc:standard:v2.1 ↵"), is known as a **text string**, or more fully, an **abc text string**. (Note that the abc standard version 2.0 referred to a [text string](#text_string_definition "abc:standard:v2.1 ↵") as an *abc string*.)

Typically when there are several lines of text, each line forms a separate [text string](#text_string_definition "abc:standard:v2.1 ↵"), although the distinction is not essential.

The contents of a text string may be written using any legal [character set](#charset_field "abc:standard:v2.1 ↵"). The default character set is `utf-8`, giving access to every Unicode character.
...
All conforming abc typesetting software should support (understand and be able to convert) the subset of accents and ligatures given in the appendix, [supported accents & ligatures](#supported_accents_ligatures "abc:standard:v2.1 ↵"), together with the special characters and symbols listed below.
...
Characters that are meaningful in the context of a [text string](#text_string_definition "abc:standard:v2.1 ↵") can be escaped using a backslash as follows:

* type `\\` to get a backslash;
* type `\%` to get a percent symbol that is not interpreted as the start of a [comment](#comments_and_remarks "abc:standard:v2.1 ↵");
...
* type `&quot;` or `\u0022` to get double quote marks in an [annotation](#annotations "abc:standard:v2.1 ↵")
...
*VOLATILE:*  Finally note that currently the specifiers `$1`, `$2`, `$3` and `$4` can be used to change the font within a [text string](#text_string_definition "abc:standard:v2.1 ↵"). However, this feature is likely to change in future versions of the standard - see [font directives](#font_directives "abc:standard:v2.1 ↵") for more details.
...
Software implementing these macros, should first expand the macros defined in this section, and only afterwards apply any relevant `U:` replacement (see [Redefinable symbols](#redefinable_symbols "abc:standard:v2.1 ↵")).

When these macros are stored in an abc header file (see [include field](#include_field "abc:standard:v2.1 ↵")), they may form a powerful library.
...
Please see [http://www.ietf.org/rfc/rfc2119.txt](http://www.ietf.org/rfc/rfc2119.txt "http://www.ietf.org/rfc/rfc2119.txt") for formal definitions of the key words MUST, MUST NOT, REQUIRED, SHALL, SHALL NOT, SHOULD, SHOULD NOT, RECOMMENDED, MAY, and OPTIONAL in this context.
...
The `A:` [field](#aarea "abc:standard:v2.1 ↵") was originally used to contain area information. In version 2.0 this was changed to contain the name of the lyrics author. In version 2.1, to maintain backwards compatibility, this has been changed back to area, but for clarity, the `A:` field is [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") - area information can be stored in the `O:` field and a new field  *(to be decided)*  will be used for author information.

*Comment:*  Of the 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search") 16,300 contain an `A:` field with 680 distinct values. Of these, only around 10 contain author information rather than area (in some cases it is difficult to tell).
...
This is not very musical, and the usage is [deprecated](#outdated_syntax "abc:standard:v2.1 ↵"). However, there are many [abc files](#abc_file_definition "abc:standard:v2.1 ↵") which employ this syntax and programs should accept it.

### 10.2 Outdated dialects

#### 10.2.1 Outdated line-breaking

The popular abc software abc2win introduced an exclamation mark (`!`) as a way of forcing a [score line-break](#score_line-break_definition "abc:standard:v2.1 ↵") and this was adopted by abc 2.0, conflicting with the previous usage of `!…!` to delimit decorations.

The `!` is now [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") for [score line-breaks](#score_line-break_definition "abc:standard:v2.1 ↵") although it is still available (even under [strict interpretation](#strict_interpretation "abc:standard:v2.1 ↵")) for legacy abc transcriptions by use of the "`I:linebreak !`" directive - see [line-breaking dialects](#line-breaking_dialects "abc:standard:v2.1 ↵").

#### 10.2.2 Outdated decorations

Abc standard 2.0 adopted `+…+` syntax to indicate decorations in place of `!…!`. It never gained much favour, however, and the latter is in much more common (see [decoration dialects](#decoration_dialects "abc:standard:v2.1 ↵")).

Therefore, and since a non-conflicting mechanism has now been found to allow `!` for line-breaking (see [line-breaking dialects](#line-breaking_dialects "abc:standard:v2.1 ↵")), the `+…+` decoration syntax is now [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") in favour of `!…!`.

Nonetheless, the `+…+` decoration syntax is still available using the "`I:decoration +`" instruction (see [decoration dialects](#decoration_dialects "abc:standard:v2.1 ↵")).

#### 10.2.3 Outdated chords

Early versions of the abc standard used the `+` symbol to delimit chords (in place of `[]` symbols). This usage is now [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") - see [chord dialects](#chord_dialects "abc:standard:v2.1 ↵") for more details.

### 10.3 Outdated continuations

From the earliest days of abc (in abc standard 1.0 through to abc 1.7.6), the backslash (`\`) has been used to suppress [score line-breaks](#score_line-break_definition "abc:standard:v2.1 ↵") by placing it at the end of a line of [music code](#music_code_definition "abc:standard:v2.1 ↵"). Thus, effectively, it has acted as a continuation character, although with its own special rules, in particular that it could act through [information fields](#information_field_definition "abc:standard:v2.1 ↵") and [comments](#comment_definition "abc:standard:v2.1 ↵").

Abc 2.0 extended this usage to make `\` a general continuation character, which also allows continuation of [information fields](#information_field_definition "abc:standard:v2.1 ↵") and in particular the `w:` lyrics field (usually the only field which actually requires a continuation in typical transcriptions). Unfortunately, however, the rules of precedence were never well established (should the `\` be treated by a pre-processor joining together continued lines and, if so, should comments be removed before or after that happened?) and the usage was never widely adopted, nor even well understood.

*Comment:*  Of the 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search"), only 22 (0.01%) use continuations for the `w:` field and only around 50 (0.03%) use it for any other field; of these latter usages, almost all are actually in error.

Furthermore, discussions during the development of abc 2.1 led to the suggestion that a new character should be introduced to suppress [score line-breaks](#score_line-break_definition "abc:standard:v2.1 ↵") - in other words the `\` (as described in abc 2.0) had evolved far enough away from its initial definition so that another character was required to replace what it had originally been designed to do.

Consequently, in abc 2.1 the `\` has been reinstated to its original purpose of suppressing [score line-breaks](#score_line-break_definition "abc:standard:v2.1 ↵") (see [typesetting line-breaks](#typesetting_line-breaks "abc:standard:v2.1 ↵")) and its use a general continuation character is now [disallowed](#outdated_syntax "abc:standard:v2.1 ↵") (see [continuation of input lines](#continuation_of_input_lines "abc:standard:v2.1 ↵") for the alternatives).

### 10.4 Outdated directives

The `%%continueall true` directive is replaced by "`I:linebreak !`" in abc 2.1 (see [typesetting line-breaks](#typesetting_line-breaks "abc:standard:v2.1 ↵")) and [deprecated](#outdated_syntax "abc:standard:v2.1 ↵").

The `%%abc-copyright` and `%%abc-edited-by` extended information fields from section 3.3. of abc 2.0 have been [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") in favour of the [Z: - transcription](#ztranscription "abc:standard:v2.1 ↵") field.

*Comment:*  Of the 131,000 files currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search") only 32 use `%%abc-edited-by` and only 1 uses `%%abc-copyright`.

### 10.5 Outdated file structure

#### 10.5.1 Outdated tune header syntax

Abc standard 2.0 included the rule that 'if the [abc file](#abc_file_definition "abc:standard:v2.1 ↵") contains only one tune the `X:` field may be dropped'. However, it was pointed out that as a consequence, a user who pasted an additional tune into such a file would get an error message from a tune which previously contained no errors.

Despite considerable discussion on the abcusers mail list (see for example the threads [http://tech.groups.yahoo.com/group/abcusers/message/3950](http://tech.groups.yahoo.com/group/abcusers/message/3950 "http://tech.groups.yahoo.com/group/abcusers/message/3950") and [http://tech.groups.yahoo.com/group/abcusers/message/4113](http://tech.groups.yahoo.com/group/abcusers/message/4113 "http://tech.groups.yahoo.com/group/abcusers/message/4113")) and, a number of good suggestions, no consensus was reached. As a result the above rule is [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") in abc 2.1; a tune must start with a `X:` field followed by a `T:` field.

However, this decision may be revisited in the future and the specification relaxed.

#### 10.5.2 Outdated defaults

In early versions of the abc standard, defaults could be set throughout an [abc file](#abc_file_definition "abc:standard:v2.1 ↵"), using [information fields](#information_field_definition "abc:standard:v2.1 ↵"), which applied to all subsequent tune. In other words, the [file header](#file_header_definition "abc:standard:v2.1 ↵") could effectively appear anywhere inside a file instead of just at the top.

This usage significantly complicates random access of the tunes in the file, since the all the preceding contents of the file must be scanned for default settings before a tune can be processed. As result this was [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") in abc 2.0 and is [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") in abc 2.1.

### 10.6 Outdated lyrics alignment

Abc 2.1 introduced an extension to [lyrics alignment](#alignment "abc:standard:v2.1 ↵") meaning that lyric lines (i.e. those using the `w:` field) no longer need to follow immediately after the line of [music code](#music_code_definition "abc:standard:v2.1 ↵") to which they are attached, meaning that they can even be postponed to the end of the [tune body](#tune_body_definition "abc:standard:v2.1 ↵").

*Examples:*  The following two excerpts are equivalent in abc 2.1; under abc 2.0 and previous versions of the standard, only the first version would be legal. Note that there are 4 ([numbered](#numbering "abc:standard:v2.1 ↵")) verses and hence 4 `w:` fields for each line of [music code](#music_code_definition "abc:standard:v2.1 ↵").
...
The work around for users who have files with such usage is either to avoid writing `%abc-2.1` as the [file identifier](#abc_file_identification "abc:standard:v2.1 ↵") or to add an empty `w:` field after the final line of [music code](#music_code_definition "abc:standard:v2.1 ↵") that should be without lyrics.
...
Although the use of ampersand (`&`) to overlay voices (as introduced in abc 2.0) is still perfectly acceptable, this usage has been [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") within `w:` lyric and `s:` symbol [information fields](#information_field_definition "abc:standard:v2.1 ↵").
...
Instead lyrics are matched to notes without regard to the voice overlay - see [voice overlay](#voice_overlay "abc:standard:v2.1 ↵").
...
In the early days of abc, pseudo-comments (lines starting with `%%`) were introduced as a means of adding software-specific information and formatting instructions into [abc files](#abc_file_definition "abc:standard:v2.1 ↵"); because they started with a `%` symbol software that didn't recognise them would ignore them as a [comment](#comment_definition "abc:standard:v2.1 ↵").

In a valiant effort, abc 2.0 made an attempt to standardise these pseudo-comments with the introduction [stylesheet directives](#stylesheet_directive_definition "abc:standard:v2.1 ↵") and the abc stylesheet specification. This was described as "not part of the ABC specification itself" but as "an additional standard" containing directives to control how the content and structural information described by the abc code "is to be actually rendered, for example by a typesetting or player program".

Unfortunately, however, there are a very large number of pseudo-comment directives and not all of them are well-defined. Furthermore, some directives, in particular the [text directives](#text_directives "abc:standard:v2.1 ↵") and [accidental directives](#accidental_directives "abc:standard:v2.1 ↵"), actually contain content and / or structural information (as opposed to rendering instructions).

Abc 2.1 has stepped away from this approach somewhat.

The pseudo-comments are still very much accepted as a way for developers to introduce experimental features and software-specific formatting instructions. However, when a directive gains acceptance, either by being implemented in more than one piece of software, or by its use in a substantial body of tunes, the aim is that the usage will be standardised and adopted in the standard and the `I:` [instruction](#iinstruction "abc:standard:v2.1 ↵") form recommended in place of the `%%` pseudo-comment form.
...
<html><a name="stylesheet\_directive\_definition"></a></html>A **stylesheet directive** is a line that starts with `%%`, followed by a directive that gives instructions to typesetting or player programs.
...
[Inline field](#inline_field_definition "abc:standard:v2.1 ↵") notation may be used to place a [stylesheet directive](#stylesheet_directive_definition "abc:standard:v2.1 ↵") in the middle of a line of music:
...
If a program doesn't recognise a [stylesheet directive](#stylesheet_directive_definition "abc:standard:v2.1 ↵"), it should just ignore it.

It should be stressed that the [stylesheet directives](#stylesheet_directive_definition "abc:standard:v2.1 ↵") are not formally part of the abc standard itself. Furthermore, the list of possible [directives](#stylesheet_directive_definition "abc:standard:v2.1 ↵") is long and not standardised. They are provided by a variety of programs for specifying layout, text annotations, fonts, spacings, voice instruments, transposition and other details.

Strictly speaking, abc applications don't have to conform to the same set of [stylesheet directives](#stylesheet_directive_definition "abc:standard:v2.1 ↵"). However, it is desirable that they do in order to make [abc files](#abc_file_definition "abc:standard:v2.1 ↵") portable between different computer systems.

### 11.1 Voice grouping

*VOLATILE:*  This section is under review as part of the general discussion about [multiple voices](#multiple_voices "abc:standard:v2.1 ↵") for abc 2.2. See also the [section 11 disclaimer](#disclaimer "abc:standard:v2.1 ↵").
...
Any voices appearing in the [tune body](#tune_body_definition "abc:standard:v2.1 ↵") will only be printed if it is mentioned in the score directive.

When the score directive occurs within the [tune body](#tune_body_definition "abc:standard:v2.1 ↵"), it resets the music generator, so that voices may appear and disappear for some period of time.

If no score directive is used, all voices that appear in the [tune body](#tune_body_definition "abc:standard:v2.1 ↵") are printed on separate staves.

See [Canzonetta.abc](#canzonettaabc "abc:standard:v2.1 ↵") for an extensive example.
...
*VOLATILE:*  This section is under active discussion. See also the [section 11 disclaimer](#disclaimer "abc:standard:v2.1 ↵").
...
*VOLATILE:*  Font directives are due to be considered in abc 2.3 - see the [section 11 disclaimer](#disclaimer "abc:standard:v2.1 ↵").
...
The specifiers `$1`, `$2`, `$3` and `$4` can be used to change the font within a [text string](#text_string_definition "abc:standard:v2.1 ↵"). The font to be used can be specified with the `%%setfont-n` directives. `$0` resets the font to its default value. `$$` gives an actual dollar sign.
...
*VOLATILE:*  Text directives are due to be considered in abc 2.3 - see the [section 11 disclaimer](#disclaimer "abc:standard:v2.1 ↵").

The following directives can be used for inserting [typeset text](#typeset_text_definition "abc:standard:v2.1 ↵") within an [abc file](#abc_file_definition "abc:standard:v2.1 ↵").
...
* `%%text` prints the following text, treated as a [text string](#text_string_definition "abc:standard:v2.1 ↵").
* `%%center` prints the following text, treated as a [text string](#text_string_definition "abc:standard:v2.1 ↵") and centred.
* `%%begintext` and `%%endtext` mark a section of lines, each of which start with `%%`, followed by some text. It is an alternative to several `%%text` lines. [*Important note:* some [extensions](#abc_extensions "abc:standard:v2.1 ↵") offered by abc software programs relax the rule that each line between `%%begintext` and `%%endtext` must start with `%%`. Whilst this should not cause problems for [typeset text](#typeset_text_definition "abc:standard:v2.1 ↵") between tunes, [typeset text](#typeset_text_definition "abc:standard:v2.1 ↵") within a [tune header](#tune_header_definition "abc:standard:v2.1 ↵") or [tune body](#tune_body_definition "abc:standard:v2.1 ↵") should respect this rule and, in particular, must not introduce blank lines.]

See [further information about directives](#further_information_about_directives "abc:standard:v2.1 ↵") for more details and to find out about additional parameters for these directives.

*Recommendation for users:*  If you are using text directives for tune-specific information, consider instead using one of the [background information fields](#bdfsbackground_information "abc:standard:v2.1 ↵") together with a `%%writefields` directive (see [information directives](#information_directives "abc:standard:v2.1 ↵")) so that the information can correctly identified by databasing software.
...
Since [stylesheet directives](#stylesheet_directive_definition "abc:standard:v2.1 ↵") are not formally part of the abc standard, only a subset is included here. For additional directives and further information about those listed here, see the user manuals for programs that implement them, in particular:

* the `format.txt` file included with [abcm2ps](http://moinejf.free.fr/ "http://moinejf.free.fr/")
* the `abcguide.txt` file included with [abcMIDI](http://abc.sourceforge.net/abcMIDI/ "http://abc.sourceforge.net/abcMIDI/")
* the `abctab2ps` [User's guide](http://www.lautengesellschaft.de/cdmm/userguide/userguide.html "http://www.lautengesellschaft.de/cdmm/userguide/userguide.html")
...
*Comment:*  Dialects not available under strict interpretation are those where one symbol is used for two different purposes - for example, a `!` symbol used to denote both line-breaks and decorations; fortunately, of the 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search") only around 60 (0.04%) employ this usage.
...
*Comment:*  The `!` symbol was introduced by abc2win, a very popular program in its time, although now moribund. Of the 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search"), only around 1,600 (10%) use the ! symbol to denote line-breaks.

Although the use of the `!` symbol for line-breaking is now [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") (see [outdated line-breaking](#outdated_line-breaking "abc:standard:v2.1 ↵")), users who wish to continue using the `!` symbol for line-breaking merely need to include the "`I:linebreak !`" directive, either in the [file header](#file_header_definition "abc:standard:v2.1 ↵") or individually tune by tune - see [typesetting line-breaks](#typesetting_line-breaks "abc:standard:v2.1 ↵").
...
Finally a new line-breaking symbol, `$`, has been introduced as an alternative to using [code line-breaks](#code_line-break_definition "abc:standard:v2.1 ↵").

*Comment:*  The `$` symbol is effectively a replacement for `!`. It is aimed at those users who want `!` as the decoration delimiter but who prefer to use [code line-breaks](#code_line-break_definition "abc:standard:v2.1 ↵") without generating corresponding [score line-breaks](#score_line-break_definition "abc:standard:v2.1 ↵").

#### 12.1.2 Decoration dialects

Decorations are delimited using the `!` symbol - see [decorations](#decorations "abc:standard:v2.1 ↵").

In the past the `+` symbol has instead been used to denote decorations - this symbol is now [deprecated](#outdated_syntax "abc:standard:v2.1 ↵") for decorations.

*Comment:*  Decorations were first introduced in draft standard 1.7.6 (which was never formally adopted) with the `!` symbol. In abc 2.0 (adopted briefly whilst discussions about abc 2.1 were taking place) this was changed to the `+` symbol. Neither are in widespread use, but the `!` symbol is much more common - of the 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search"), only around 100 (0.07%) use the `+` symbol to delimit decorations, whereas around 1,350 (0.85%) use the `!` symbol.

Users who wish to continue using the `+` symbol for decorations merely need to include the "`I:decoration +`" directive, either in the [file header](#file_header_definition "abc:standard:v2.1 ↵") or individually tune by tune - see [decorations](#decorations "abc:standard:v2.1 ↵"). All `+…+` decorations will then be treated as if they were the corresponding `!…!` decoration and any `!…!` decorations will generate an error message.
...
*Recommendation for users:*  Given the very small uptake of the `+` symbol for decorations, "`I:decoration +`" directive is not recommended. However, it is retained for users who wish to use the `!` symbol for line-breaking in legacy [abc files](#abc_file_definition "abc:standard:v2.1 ↵").

For completeness the "`I:decoration !`", the default setting, is also available to allow individual tunes to use `!…!` decorations in a file where "`I:decoration +`" is set in the [file header](#file_header_definition "abc:standard:v2.1 ↵").

#### 12.1.3 Chord dialects

Chords are delimited using `[]` symbols - see [chords and unisons](#chords_and_unisons "abc:standard:v2.1 ↵").

In the past the `+` symbol has instead been used to delimit chords - this symbol is no longer in use for chords.

*Comment:*  In early versions of the abc standard (1.2 to 1.5), chords were delimited with `+` symbols. However, this made it hard to see where one chord ended and another began and the chord delimiters were changed to `[]` in 1.6 (November 1996). Of the 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search"), only around 420 (0.25%) use the `+` symbol to delimit chords. Given the small uptake and the successful introduction of the `[]` symbols, there is no `I:` directive available which allows the use of `+` symbols and this usage is now [obsolete](#outdated_syntax "abc:standard:v2.1 ↵").

### 12.2 Loose interpretation

*Comment:*  There are around 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search") - loose interpretation of the abc standard maintains backwards compatibility without any changes required for this huge and valuable resource.

Any [abc file](#abc_file_definition "abc:standard:v2.1 ↵") without a version number, or with a version number of 2.0 or less (see [abc file identification](#abc_file_identification "abc:standard:v2.1 ↵") and [version field](#version_field "abc:standard:v2.1 ↵")), should be interpreted loosely. Developers should do their best to provide programs that understand legacy [abc files](#abc_file_definition "abc:standard:v2.1 ↵"), but users should be aware that loose interpretations may different from one abc program to another.
...
*Recommendation 2 for developers:*  Although moving towards strict interpretations should make life easier for everybody (developers and users alike), you should allow users to switch easily between strict and loose interpretation, perhaps via a command line switch or a GUI check-box. For example, a user who imports an old [abc file](#abc_file_definition "abc:standard:v2.1 ↵") may wish to see how it would be interpreted strictly, perhaps to establish how many strict errors need fixing.

### 12.3 Strict interpretation

Any [abc file](#abc_file_definition "abc:standard:v2.1 ↵") with an abc version number greater than or equal to 2.1 (see [abc file identification](#abc_file_identification "abc:standard:v2.1 ↵") and [version field](#version_field "abc:standard:v2.1 ↵")) should be interpreted strictly, with errors indicated to the user as such.
...
For more details see [text strings](#text_strings "abc:standard:v2.1 ↵") and for further information see, for example:

* [http://www.w3.org/TR/html4/sgml/entities.html](http://www.w3.org/TR/html4/sgml/entities.html "http://www.w3.org/TR/html4/sgml/entities.html")
* [http://en.wikipedia.org/wiki/List\_of\_XML\_and\_HTML\_character\_entity\_references](http://en.wikipedia.org/wiki/List_of_XML_and_HTML_character_entity_references "http://en.wikipedia.org/wiki/List_of_XML_and_HTML_character_entity_references")
* [http://en.wikipedia.org/wiki/List\_of\_Unicode\_characters](http://en.wikipedia.org/wiki/List_of_Unicode_characters "http://en.wikipedia.org/wiki/List_of_Unicode_characters")
* [http://www.fileformat.info/info/unicode/char/search.htm](http://www.fileformat.info/info/unicode/char/search.htm "http://www.fileformat.info/info/unicode/char/search.htm") - unicode character search
...
* [Section 1.1.1 Terminology / definitions](#terminology_definitions "abc:standard:v2.1 ↵"): The definition of *VOLATILE* has been clarified; it is used to indicate "sections which are under active discussion and/or are likely to change in some future version of the standard" rather than "sections which are under active discussion or likely to change at some point in the future" (8th Jan 2012).
* [Section 6.1.1 Typesetting line-breaks](#typesetting_line-breaks "abc:standard:v2.1 ↵"): Typo: `setbarno` corrected to `setbarnb` in two places (8th Jan 2012).
* [Section 8.2 Text strings](#text_strings "abc:standard:v2.1 ↵"): Typos for accent mnemonics (cedilla and ring): "`\,C \,c`" and "`\oA \oa`" corrected to "`\cC \cc`" and "`\AA \aa`", respectively, as per [Section 14.1 Supported accents & ligatures](#supported_accents_ligatures "abc:standard:v2.1 ↵") (8th Jan 2012).  
...
* [Section 11.4.6 Information directives](#information_directives "abc:standard:v2.1 ↵"): The statement "Note that the `%%writefields` directive does not apply to instruction-type fields, such as parts (P) and tempo (Q)" has now been removed, as it conflicted with other information in the same section (8th Jan 2012).
* [Section 4.18 Chord symbols](#chord_symbols "abc:standard:v2.1 ↵"): Typo: `sustained` corrected to `suspended` (26th May 2012).
* [Section 4.6 Clefs and transposition](#clefs_and_transposition "abc:standard:v2.1 ↵"): following discussion, this section has been corrected to clarify that the `middle` setting does not affect the playback (since there is no consistent way that it can do so). The [Zocharti Loch example](#multiple_voices "abc:standard:v2.1 ↵") has been corrected and its accompanying midi file (which has persisted unchanged from abc draft 2.0, and which seemed to indicate `middle` might, in some circumstances, affect the playback) has been removed (20th February 2013).
