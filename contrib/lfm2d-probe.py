...
PROBES = [
    ...
    ("kj", "kj config reset /etc/config/theme.toml", "situation-normal"),
...
ALIAS_PAIRS = [
    ...
    ("kj rc rm /etc/rc/coder/create/S00-stance.kai",
     "kj rc remove /etc/rc/coder/create/S00-stance.kai", "rc.rs:71"),
